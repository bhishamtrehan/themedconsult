...
jQuery.validator.addMethod("nospace",function(spaceset, element){	
 ...
 $.validator.addMethod("noSpaceReq", function(value, element) { 
	...
	$(".clinic_suburb").autocomplete({
		source: baseUrl+"/clinic/getsuburbs",
...
function addNewEmail(cliLngth){
	...
	var html = '<div class="form-group" id="newEmail_'+newLngth+'"><label class="col-sm-3 control-label">Office Email ID</label><div class="col-sm-9"><input class="form-control" type="text" placeholder="Enter email address" autocomplete="off" size="30" maxlength="80" value="" name="clinic_admin_email[]"><span class="cross_btn"><a href="javascript:void(0);" onclick="removeEmail('+newLngth+')">Delete</a></span></div></div>';
	$('.newEmailAddress').html('<a href="javascript:void(0);"><i class="fa fa-plus" onClick="addNewEmail('+newLngth+')"></i></a>');
...
function addNewRoom(cliLngth){
	...
	var html = '<div class="form-group" id="newroom_'+newLngth+'"><label class="col-sm-3 control-label">Room</label><div class="col-sm-9"><input type="text" class="form-control" placeholder="Room" autocomplete="off" size="30" maxlength="80" value="" name="clinic_room[]"><span class="cross_btn"><a href="javascript:void(0);" onclick="removeRoom('+newLngth+')">Delete</a></span></div></div>';
	$('.newroom').html('<a  href="javascript:void(0)"><i class="fa fa-plus" onClick="addNewRoom('+newLngth+')"></i></a>');
	$('#roomAdd').append(html);
