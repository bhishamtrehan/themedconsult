              ...
              <?php echo form_open($this->uri->uri_string(),array('class' => 'form-horizontal form_health','id' => 'add_clinic_form')); ?>
                <fieldset>
				 ...
				 <div class="form-group">
                  ...
                  <div class="form-group" id="city_lists" style="display:none;">
                    <label class="col-sm-3 control-label"><?php echo $this->lang->line('city'); ?><span class="astrik">*</span></label>
                    <div class="col-sm-9">
                  ...
                  <div class="col-lg-6">
					 <div id="clinicno">
					  ...
					  <div class="newOfficeNo"><a  href="javascript:void(0)" onClick="addNewTelephone(1)"><?php echo $this->lang->line('add_another_telephone'); ?></a></div>
					  ...
					  <div class="newFaxNo"><a  href="javascript:void(0)" onClick="addNewFax(1)"><?php echo $this->lang->line('add_another_fax'); ?></a></div>
					...
					<div class="newEmailAddress"><a  href="javascript:void(0)" onClick="addNewEmail(1)"><?php echo $this->lang->line('add_another_email'); ?></a></div>
					...
					<div class="newroom"><a  href="javascript:void(0)" onClick="addNewRoom(1)"><?php echo $this->lang->line('add_another_room'); ?></a></div>
