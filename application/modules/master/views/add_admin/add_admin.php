...
$country = form_dropdown('country', $countries, '', 'id="country" class="form-control m-b-sm"' );
$status_drop = array('1' => 'Pending', '0' => 'Approved' );
$status = form_dropdown('status', $status_drop, '', 'id="status" class="form-control m-b-sm"');
$clinics = form_dropdown('clinic_loc[]', $clinicloc, '', 'id="status" class="form-control m-b-sm" multiple');
...
<script src="<?php echo base_url();?>assets/js/mc_js/admin/add_admin/add_admin.js"></script>
