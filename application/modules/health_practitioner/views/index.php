    ...
    <div class="bottom c_fullcalendar">
      <div class="container c_fullcalendar">
        ...
        <!-- <input type='hidden' id='left_clinic_minicalendar'/> -->
                ...
                <?php echo form_open('', array('class' => 'filter-clinic-locations')); ?>
          ...
          <!-- end left sidebar --> 
          <div class="col-md-12 content-wrapper practitioner_sectn appointment_dash c_fullcalendar"> <!-- InstanceBeginEditable name="body" -->
            <!-- top general alert -->
...
<!--<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/full_calendar/fullcalendar.min.js"></script>-->
  ...
  <script src="<?php echo base_url(); ?>assets/js/mc_js/health_practitioner/appointment/calendar.js"></script>
