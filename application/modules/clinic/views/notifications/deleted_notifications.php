    ...
    <div class="row">
      ...
      <div class="col-md-12 notif_wrapper">
        <div class="left_panel">
          <ul>
            <li><a href="<?php echo base_url(); ?>clinic/notifications/archived_notification" id="archive"><i class="fa fa-folder-open"></i>Archive</a></li>
            <li><a href="<?php echo base_url(); ?>clinic/notifications" id="recycle"><i class="fa fa-recycle"></i>Notifications</a></li>
          </ul>
        </div>
        <div class="panel panel-white">
          <div class="panel-body">
            ...
            $notifications = $this->mc_constants->deleteNotifications($userId);
            $getNotifiyCount = $this->mc_constants->deleteNotifications($userId);
            //echo "<pre>";
                ...
                <?php if ($roleID == 2 && $notify['recipient_id'] == $userId) { ?>
                  ...
                  <li id="<?php echo $notify['id']; ?>">
                    ...
                    <p class="n_desc"> <?php  echo sprintf($this->lang->line('hp_to_clinic'), $notify['username']); ?></p>
                     <span class="time"><?php echo $notify['created']; ?></span>
                     <ul class="n_action">
                        <li><a href="javascript:void(0)" data-id="<?php echo $notify['id']; ?>" class="restore"><i class="fa fa-folder-open"></i>Restore</a></li>
