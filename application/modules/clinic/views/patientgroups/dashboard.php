        ...
        <div class="panel panel-white dashboardWrap">
             ...
             <table id="groupListInfo" class="tt view_php display table table-sorting table-hover table-bordered datatable dataTable no-footer" cellspacing="0" width="100%">
              ...
              <tbody>
                  ...
                  <td> <span class="action-btn-sec centeraction"><a href="javascript:void(0)" style="color:#000;" data-groupid="<?php echo $list['id']; ?>" class="grpId"><span class="view-icon"></span><span class="linktext"><?php echo $this->lang->line('viewDetails'); ?></span></a></span></td>
                  </tr>
                  <?php } ?>  
              </tbody>
