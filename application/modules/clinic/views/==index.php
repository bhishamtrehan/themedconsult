...
.ui-datepicker select.ui-datepicker-month, .ui-datepicker select.ui-datepicker-year {
  ...
  <div class="col-md-3 ">
    <div style="width: 100%;" id="left_clinic_minicalendar"></div>   
</div>
		  <!-- end left sidebar --> 
		<div class="col-md-9 content-wrapper practitioner_sectn appointment_dash"> <!-- InstanceBeginEditable name="body" -->
			<!-- top general alert -->
            ...
            <?php echo form_submit('submit', $this->lang->line('submit'),"class=''").form_close();?> 
				...
				<?php if(sizeof($locationPracs)>0) {?>
					<span id="book_another_appnt" style="display:none;"></span>
                                        <div class="table-responsive"><div class="calendar"></div></div>
				<?php } else { echo $this->lang->line('no_prac_assign');}?>
                <!-- /content-wrapper --> 
                </div>
		    </div>	
		</div>
