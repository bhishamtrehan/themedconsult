...
?>
	...
	<div class="top_right_invoice" style="width: 90%;">
            ...
            <a href="javascript:void(0);" id="<?php echo $this->encryption->encode($appntDetails->appointment_id);?>" appointment_date="<?php echo $appntDetails->appointment_date;?>" class="btn btn-danger"><?php echo $this->lang->line('cancel_appointment');?></a>
            <a href="javascript:void(0);" id="<?php echo $this->encryption->encode($appntDetails->appointment_id);?>" appointment_date="<?php echo $appntDetails->appointment_date;?>" class="btn btn-info" onclick="popitup('<?php echo base_url(); ?>clinic/appointment/edit_appointment?startDate=<?php echo $appoint_startdate; ?>&startTime=<?php echo $appoint_starttime; ?>&endTime=<?php echo $appoint_endtime; ?>&endDate=<?php echo $appoint_enddate; ?>&resource=<?php echo $pract_id; ?>&appointment_id=<?php echo $this->encryption->encode($appid); ?>')"><?php echo $this->lang->line('edit_appointment');?></a>
        </div>
