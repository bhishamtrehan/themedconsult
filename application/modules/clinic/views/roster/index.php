...
<div class="wrapper c_fullcalendar"> 
  ...
  <!-- TOP BAR -->
  <?php //echo $this->shc_constants->tob_bar('');
...
.ui-datepicker select.ui-datepicker-month, .ui-datepicker select.ui-datepicker-year {
  ...
  <div class="col-md-3  c_fullcalendar">
    <div  class="com_l_cal c_fullcalendar" >
      ...
      <div style="width: 100%;" class="dash-cal" id="left_clinic_minicalendar"></div>  
    </div>
     
</div>
		  <!-- end left sidebar --> 
		<div class="col-md-9 content-wrapper practitioner_sectn appointment_dash c_fullcalendar"> <!-- InstanceBeginEditable name="body" -->
			<!-- top general alert -->
          ...
          <div class="alert alert-danger c_alert" role="alert">
                    ...
                    <?php
                    echo $this->lang->line('no_rooms_assign');
                 ?>
          </div>
                <?php  } ?>
...
<script src="<?php echo base_url();?>assets/js/mc_js/clinics/appointment/Rostercalendar.js"></script>
