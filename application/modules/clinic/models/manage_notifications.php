...
class Manage_notifications extends CI_Model
{
	...
	private $mc_notifications 	            = 'mc_notifications';
	...
	function __construct()
	{
		...
		$this->mc_notifications   	                = 	$ci->config->item('db_table_prefix', 'tank_auth').$this->mc_notifications;
	}
...
public function archive_notification($inputValues){
		...
		$notification['last_modified_ip'] = $ipAddress;
		$notification['last_modified_date'] = date('Y-m-d H:i:s');
		
		
			$data = array(
			               'modified' => $notification['last_modified_date'],
			               'last_modified_ip' => $notification['last_modified_ip'],
			...
			$this->db->where('id', $id);
			$this->db->update($this->mc_notifications, $data); 
...
public function delete_notification($inputValues){
...
public function restore_notification($inputValues){
