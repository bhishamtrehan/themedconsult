		...
		<div class="col-md-10 content-wrapper practitioner_sectn"> <!-- InstanceBeginEditable name="body" -->			  
          ...
          <div>
            <div class="widget-content"  id="checking_security">
              <?php echo form_open($this->uri->uri_string(),array('class' => 'form-horizontal form_health','id' => 'check_security_question_first')); ?>
                <fieldset>
                  <legend><?php echo $this->lang->line('general_info');?></legend>
                  
                 <div class="col-lg-12 ">
                  <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo $this->lang->line('select_question_lable_first'); ?><span class="astrik">*</span></label>
                    <div class="col-sm-9">
						<?php echo  form_dropdown('question_first', $question, $question_first, 'id="question_first"');  ?>
                    </div>
				  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo $this->lang->line('answer_first_question'); ?><span class="astrik">*</span></label>
                    <div class="col-sm-9">
						<?php echo form_input($answer_first); ?>                    
					</div>					
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                      <?php //echo form_hidden('action', $action);
					  echo form_submit('next', $this->lang->line('next'),"class='btn btn-primary btn-block'"); ?>
                    </div>
                  </div>
                  <?php echo form_close();?>
