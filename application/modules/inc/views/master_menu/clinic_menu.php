    ...
    <div class="page-sidebar-inner">
        <ul class="menu accordion-menu">
          ...
          <!-- <li class="<?php echo ($this->uri->segment(2)=='dashboard' || $this->uri->segment(3)=='dashboard')?'active':''; ?>"><a href="<?php echo base_url();?>clinic/dashboard"><span class="menu-icon fa fa-medkit"></span><p><?= $this->lang->line('clinic_menu_dashboard');?></p></a></li>-->
           <li class="<?php echo ($this->uri->segment(1)=='clinic' && $this->uri->segment(2)=='')|| ($this->uri->segment(1)=='clinic' && $this->uri->segment(2)=='add')?'active':''; ?>"><a href="<?php echo base_url();?>clinic"><span class="menu-icon fa fa-medkit"></span><p><?= $this->lang->line('clinic_menu_setting');?></p></a></li>
