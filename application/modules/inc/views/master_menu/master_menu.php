    ...
    <div class="page-sidebar-inner">
        <ul class="menu accordion-menu">
           ...
           <!-- <li><a href="<?php echo base_url();?>master/clinics"><span class="menu-icon fa fa-medkit"></span><p>Clinic Settings</p></a></li>
            ...
            <li class="<?php echo ($this->uri->segment(2)=='pdf' || $this->uri->segment(3)=='pdf')?'active':''; ?>"><a href="<?php echo base_url();?>master/pdf"><span class="menu-icon fa fa-file"></span><p><?= $this->lang->line('pdf_demo');?></p></a></li>
        </ul>
